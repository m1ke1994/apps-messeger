<template>
  <section class="relative flex h-full min-h-[520px] w-full overflow-hidden rounded-3xl bg-black text-white shadow-xl">
    <div
    ...
    <header class="relative z-10 flex items-start justify-between px-6 pt-6">
      <div>
    ...
    <main class="relative z-10 flex flex-1 items-center justify-center px-6">
      <div class="relative aspect-[9/16] w-64 overflow-hidden rounded-3xl border-8 border-white/10 shadow-2xl">
        <div
        ...
        <div
          v-if="cameraOff"
          class="absolute inset-0 flex items-center justify-center bg-black/60 text-sm font-medium text-white/80"
        >
          Camera off
        </div>

        <div class="absolute bottom-4 right-4 h-24 w-16 overflow-hidden rounded-xl border-4 border-white/20 shadow-lg">
          <div
            v-if="cameraOff"
    ...
    <footer class="relative z-10 flex flex-wrap items-center justify-center gap-4 px-6 pb-10">
      <button
        type="button"
